...
def specifyCommandLineOptions():
    ...
    only_double_compact_objects = True
    ...
    common_envelope_hertzsprung_gap_assumption = 'PESSIMISTIC_HG_CE'
    ...
    mass_transfer_angular_momentum_loss_prescription = 'ISOTROPIC' #'ARBITRARY' #'ISOTROPIC'
    mass_transfer_accretion_efficiency_prescription = 'THERMAL' #'FIXED' #'THERMAL'
